...
public class ActivityControllerTest {
    ...
    void validActivityTest() throws Exception {
        ActivityDTO validActivity = new ActivityDTO(null, "activity1", "description1", 10L, 1L);
    ...
    void inValidActivityTestBlankName() throws Exception {
        ...
        ActivityDTO invalidActivityWithBlankName = new ActivityDTO(null, "", "location", 10L, 1L);
        mockMvc.perform(MockMvcRequestBuilders.post(ActivityController.BASE_URI)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void inValidActivityTestBlankDescription() throws Exception {
        ...
        ActivityDTO invalidActivityWithBlankDescription = new ActivityDTO(null, "activity1", "", 10L, 1L);
        mockMvc.perform(MockMvcRequestBuilders.post(ActivityController.BASE_URI)
                        .contentType(MediaType.APPLICATION_JSON)
