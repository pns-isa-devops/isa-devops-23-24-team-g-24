...
public class ActivityRepositoryTest {
    ...
    void testIdGenerationAndUnicity() {
        Activity padel = new Activity("Padel", "Sophia Antipolis", 55L, 5, 10, 10);
    ...
    @Test
    void testBlankName() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("", "Sophia Antipolis", 55L, 5, 10, 10)));
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("    ", "Sophia Antipolis", 55L, 5, 10, 10)));
    }

    @Test
    void testBlankLocation() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("padel", "", 1L, 5, 10, 10)));
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("padel", " ", 1L, 5, 10, 10)));
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("padel", "     ", 1L, 5, 10, 10)));
    }
