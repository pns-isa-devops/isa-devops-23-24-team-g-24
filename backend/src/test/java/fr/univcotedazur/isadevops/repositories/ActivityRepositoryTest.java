...
public class ActivityRepositoryTest {
    ...
    void testIdGenerationAndUnicity() {
        Activity padel = new Activity("Padel", "Sophia Antipolis", 55L);
    ...
    @Test
    void testBlankName() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("", "Sophia Antipolis", 55L)));
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("    ", "Sophia Antipolis", 55L)));
    }

    @Test
    void testBlankLocation() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("padel", "", 1L)));
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("padel", " ", 1L)));
        Assertions.assertThrows(ConstraintViolationException.class, () -> activityRepository.saveAndFlush(new Activity("padel", "     ", 1L)));
    }
